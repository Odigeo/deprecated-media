...
class Api
  ...
  def self.get(*args)    call(INTERNAL_SOA_API_URL, :get, *args);    end
  def self.post(*args)   call(INTERNAL_SOA_API_URL, :post, *args);   end
  def self.put(*args)    call(INTERNAL_SOA_API_URL, :put, *args);    end
  def self.delete(*args) call(INTERNAL_SOA_API_URL, :delete, *args); end
